# Ruleset v0.2.0 - Front Matter Schema

This document provides a comprehensive reference for the YAML front matter schema used in Ruleset v0.2.0. The front matter defines rule metadata, provider configuration, and compilation behavior.
...
**Type**: `string`
**Description**: Specifies the Ruleset format version this rule conforms to.
**Current Value**: `'0.2.0'`
...
cursor:
  ...
  handlebars:
    force: true
    partials:
      footer: 'Generated by Ruleset v0.2.0'
```
...
The Ruleset linter enforces these validation rules:
...
For the latest schema documentation, always refer to the version matching your Ruleset installation.